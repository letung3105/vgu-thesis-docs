...
By substituting $S = \alpha / \beta$ and $I = I_{max}$ into \autoref{eq:sir-I-wrt-S-orbits} we can obtain the maximum number of infective individuals, which is attained when $I' = 0$ \cite{brauerCompartmentalModelsEpidemiology2008}
\begin{equation*}
