...
Here a quick summary of some of the compartmental models created during the early phase of the pandemic are given while the problem they were solving are noted.
...
One exception is the model from \cite{ramchandaniDeepCOVIDNetInterpretableDeep2020}, where how each of the external factors affects the dynamics can be deducted, but well-studied metrics in epidemiology still can not be derived from the model.
