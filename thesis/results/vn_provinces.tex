...
\begin{table}[!htb]
    ...
    \end{tabular}
    \caption[Out-of-sample-errors for the number of deaths for Vietnam provinces]{Out-of-sample errors of the model's predictions on the number of deaths for the provinces in Vietnam. The lowest errors for each evaluation metrics at each location are highlighted.}
...
\begin{table}[!htb]
    ...
    \end{tabular}
    \caption[Out-of-sample-errors for the number of new cases for Vietnam provinces]{Out-of-sample errors of the model's predictions on the number of new cases for the provinces in Vietnam. The lowest errors for each evaluation metrics at each location are highlighted.}
...
\begin{table}[!htb]
    ...
    \end{tabular}
    \caption[Out-of-sample-errors for the number of cumulative cases for Vietnam provinces]{Out-of-sample errors of the model's predictions on the number of cumulative cases for the provinces in Vietnam. The lowest errors for each evaluation metrics at each location are highlighted.}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\linewidth]{Re_and_fatality_binhduong.pdf}
    \caption[Learnt effective reproduction number and fatality rate for Binh Duong]{The effective reproduction number (left) and the fatality rate (right) for Binh Duong learned by different versions of the model}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\linewidth]{Re_and_fatality_dongnai.pdf}
    \caption[Learnt effective reproduction number and fatality rate for Dong Nai]{The effective reproduction number (left) and the fatality rate (right) for Dong Nai learned by different versions of the model}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\linewidth]{Re_and_fatality_hcm.pdf}
    \caption[Learnt effective reproduction number and fatality rate for Ho Chi Minh city]{The effective reproduction number (left) and the fatality rate (right) for Ho Chi Minh city learned by different versions of the model}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\linewidth]{Re_and_fatality_longan.pdf}
    \caption[Learnt effective reproduction number and fatality rate for Long An]{The effective reproduction number (left) and the fatality rate (right) for Long An learned by different versions of the model}
